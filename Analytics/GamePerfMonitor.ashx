--rbxsig%iBI3kbv96R6kLgnFNN3beI/J6RrIU5pCRrlr8WXHXI3ecF9LbxfrKWDHCg0B3/SB1u9426uB8aDHGb1zTTS1qNqXkVjKP3+DgghMZ+8ZladUpz78G6gj9VHmCFqTDdrqPHRY3m9cPsUpNYx89M8woCcbJMQndlMGoMTBUWzD1Ic=%
...
function postFrmStats(t, id)
	...
	local url = "https://www.roblox.com/Analytics/Measurement.ashx?Type=Game.Performance.FrameRateManager&IPFilter=primary&SecondaryFilterName=" .. idtype .. "&SecondaryFilterValue=" .. tostring(id);
	--print(url)
	--print(poststring)
	game:HttpPost(url, poststring, false)
end
